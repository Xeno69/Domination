...
if (hasInterface) then {
	...
	d_remove_from_arsenal = [
		...
		[], // launchers
		[], // handguns
		[{_this select [0, 4] != "U_O_"}, {getText (configFile>>"CfgWeapons">>_this>>"ItemInfo">>"containerClass") == "Supply500"}, {d_player_side == blufor && {_this == "U_O_V_Soldier_Viper_F" || {_this == "U_O_V_Soldier_Viper_hex_F"}}}, {_this select [0, 4] == "U_C_"}, {_this == "U_OrestesBody"}], // uniforms
