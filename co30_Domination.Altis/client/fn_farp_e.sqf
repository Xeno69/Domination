...
if (player getUnitTrait "engineer") then {
	(_this select 0) addAction [format ["<t color='#AAD9EF'>%1</t>", localize "STR_DOM_MISSIONSTRING_513"], {call d_fnc_restoreeng}, 0, -1, false, false, "", "!d_eng_can_repfuel && {alive player}", 10];
};
