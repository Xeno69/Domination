...
if ((_this # 0) < 50000) then {
	execVM format ["missions\%3\%2%1.sqf", _this # 0, d_sm_fname, d_sm_folder];
} else {
	[_this # 0] call d_fnc_getbymarkersm;
};
sleep 7.012;
[_this # 0, d_x_sm_pos, d_x_sm_type] call d_fnc_s_sm_up;
