							...
							if (!_isRoof || {_edge}) then {
								...
								if (_unitMovementMode == 0) then {
									if (d_ai_aware == 1) then {
										[_uuidx, d_side_player, d_ai_pursue_dist, 0, 0, 10] spawn d_fnc_hallyg_dlegion_Snipe_awareness;
									};
								};
								...
								if (_unitMovementMode == 1) then {
									...
									[_uuidx, d_side_player, 69, 0, 0, 10] spawn d_fnc_hallyg_dlegion_Snipe_awareness;
									if !(_doMove) then {
								...
								if (_unitMovementMode == 2) then {
									...
									if (d_snp_aware == 1) then {
										...
										[_uuidx, d_side_player, 1, 1, 1, 10] spawn d_fnc_hallyg_dlegion_Snipe_awareness;
									} else {
								...
								if (_unitMovementMode == 3) then {
									if !(_doMove) then {
										...
										[_uuidx, d_side_player, 1, 0, 0, 10] spawn d_fnc_hallyg_dlegion_Snipe_awareness;
									};
								};
