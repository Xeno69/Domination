...
d_sm_apc = switch (d_enemy_side_short) do {
	case "E": {["O_APC_Tracked_02_cannon_F","O_T_APC_Tracked_02_cannon_ghex_F"] select d_tanoa};
	case "W": {["B_APC_Tracked_01_rcws_F","B_T_APC_Tracked_01_rcws_F"] select d_tanoa};
