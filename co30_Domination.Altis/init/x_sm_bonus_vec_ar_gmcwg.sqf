	...
	case "WEST": {
		call {
			if (d_gmcwgwinter) exitWith {
				["gm_ge_army_gepard1a1_win","gm_ge_army_Leopard1a1a1_win","gm_ge_army_Leopard1a1a2_win","gm_ge_army_Leopard1a1a3_win","gm_ge_army_Leopard1a1a4_win","gm_ge_army_Leopard1a3_win","gm_ge_army_Leopard1a3a1_win","gm_ge_army_Leopard1a3a2_win","gm_ge_army_Leopard1a3a3_win","gm_ge_army_m113a1g_apc_win","gm_ge_army_m113a1g_apc_milan_win","gm_dk_army_Leopard1a3_win"]
			};
			["gm_ge_army_gepard1a1","gm_ge_army_Leopard1a1a1","gm_ge_army_Leopard1a1a2","gm_ge_army_Leopard1a1a3","gm_ge_army_Leopard1a1a4","gm_ge_army_Leopard1a3","gm_ge_army_Leopard1a3a1","gm_ge_army_Leopard1a3a2","gm_ge_army_Leopard1a3a3","gm_ge_army_m113a1g_apc","gm_ge_army_m113a1g_apc_milan","gm_dk_army_Leopard1a3"]
		};
	};
