...
CREATE TABLE IF NOT EXISTS `missionsave` (
  ...
  `d_maintargets_list` varchar(600) COLLATE utf8mb4_bin NOT NULL,
  `d_current_target_index` int(11) NOT NULL,
  `d_cur_sm_idx` int(11) NOT NULL,
  `d_resolved_targets` varchar(600) COLLATE utf8mb4_bin NOT NULL,
  `d_recapture_indices` varchar(300) COLLATE utf8mb4_bin NOT NULL,
  `d_side_missions_random` varchar(600) COLLATE utf8mb4_bin NOT NULL,
  `d_current_mission_counter` int(11) NOT NULL,
  `d_searchintel` varchar(50) COLLATE utf8mb4_bin NOT NULL,
  `d_bonus_vecs_db` varchar(800) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `missionsavett` (
  ...
  `d_current_mission_counter` int(11) NOT NULL,
  `d_searchintel` varchar(50) COLLATE utf8mb4_bin NOT NULL,
  `d_bonus_vecs_db_w` varchar(800) COLLATE utf8mb4_bin NOT NULL,
  `d_bonus_vecs_db_e` varchar(800) COLLATE utf8mb4_bin NOT NULL,
  `d_worldname` varchar(50) COLLATE utf8mb4_bin NOT NULL,
